...
const AppxManifest = require('../AppxManifest');
const ConfigParser = require('cordova-common').ConfigParser;
const Version = require('../Version');

const BASE_UAP_VERSION = new Version(10, 0, 10240, 0);
...
class WindowsConfigParser extends ConfigParser {
    ...
    startPage () {
        const content = this.doc.find('content');
        if (content) return content.attrib.src;
        return null;
    }
